CREATE OR REPLACE PROCEDURE `dh-logistics-product-ops.pricing.bq_routine_asa_and_scheme_versioning` (
  IN entity_id_var STRING,
  IN test_start_date DATE,
  IN test_end_date DATE,
  IN asa_ids ARRAY <INT64>,
  IN user STRING
)
